#ifndef _ORM_LITE_FORTUNE_OPERATE_H
#define _ORM_LITE_FORTUNE_OPERATE_H
/*
...
{ /*tagnamespace_replace*/
    ...
    class fortune_opsql : public B_BASE
    {
      public:
        fortune_opsql(const std::string &tag) : dbtag(tag)
        {
        ...
        fortune_opsql() : dbtag(B_BASE::_rmstag)
        {
            std::map<std::string, std::shared_ptr<orm_conn_pool>> &conn_pool_obj = get_orm_conn_pool_obj();
            auto iter                                                            = conn_pool_obj.find(dbtag);
            if (iter != conn_pool_obj.end())
        ...
        void assign_field_value(unsigned char index_pos, unsigned char *result_temp_data, unsigned long long value_size, fortune_info::meta &data_temp)
    {
        switch(index_pos)
        {
            ...
            break;
                case 1:
            data_temp.message.assign(reinterpret_cast<const char*>(result_temp_data), value_size);
            break;
...
M_MODEL& ornotnullMessage()
	{return whereOrNotNull(B_BASE::cols::message);
        ...
        template <typename T>
        M_MODEL &where(orm::table_col<B_BASE, &fortune_info::col_names> wq, T &&val)
        {
        ...
        template <typename T>
        M_MODEL &whereOr(orm::table_col<B_BASE, &fortune_info::col_names> wq, T &&val)
        {
        ...
        M_MODEL &whereIn(orm::table_col<B_BASE, &fortune_info::col_names> wq, const std::vector<std::string> &a)
        {
            return whereIn(wq, orm::wq::in, a);
        }
        // 2 参数旧版兼容: whereIn("id", "1,2,3") = whereIn("id", split_csv("1,2,3"))
        M_MODEL &whereIn(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view csv_val)
        {
        ...
        template <typename T>
        M_MODEL &whereIn(orm::table_col<B_BASE, &fortune_info::col_names> wq, const std::vector<T> &a)
        {
        ...
        M_MODEL &whereNotIn(orm::table_col<B_BASE, &fortune_info::col_names> wq, const std::vector<std::string> &a)
        {
            return whereIn(wq, orm::wq::notin, a);
        }

        M_MODEL &whereOrIn(orm::table_col<B_BASE, &fortune_info::col_names> wq, const std::vector<std::string> &a)
        {
            return whereOrIn(wq, orm::wq::in, a);
        }

        M_MODEL &whereOrNotIn(orm::table_col<B_BASE, &fortune_info::col_names> wq, const std::vector<std::string> &a)
        {
        ...
        M_MODEL &whereNull(orm::table_col<B_BASE, &fortune_info::col_names> wq)
        {
            orm_where_sql_t item;
            item.pre_op  = wheresql.empty() ? 0 : 1;
            item.op_type = orm::wq::isnull;
        ...
        M_MODEL &whereOrNull(orm::table_col<B_BASE, &fortune_info::col_names> wq)
        {
            orm_where_sql_t item;
            item.pre_op  = wheresql.empty() ? 0 : 2;
            item.op_type = orm::wq::isnull;
        ...
        M_MODEL &whereNotNull(orm::table_col<B_BASE, &fortune_info::col_names> wq)
        {
            orm_where_sql_t item;
            item.pre_op  = wheresql.empty() ? 0 : 1;
            item.op_type = orm::wq::notnull;
        ...
        M_MODEL &whereOrNotNull(orm::table_col<B_BASE, &fortune_info::col_names> wq)
        {
            orm_where_sql_t item;
            item.pre_op  = wheresql.empty() ? 0 : 2;
            item.op_type = orm::wq::notnull;
        ...
        M_MODEL &whereEQ(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::eq, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereEQ(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::eq, val);
        }
        ...
        M_MODEL &whereAnd(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::eq, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereAnd(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::eq, val);
        }
        ...
        M_MODEL &whereBT(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::bt, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereBT(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::bt, val);
        }
        ...
        M_MODEL &whereGT(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::bt, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereGT(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::bt, val);
        }
        ...
        M_MODEL &whereBE(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::be, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereBE(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::be, val);
        }
        ...
        M_MODEL &whereGE(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::be, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereGE(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::be, val);
        }
        ...
        M_MODEL &whereLT(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::lt, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereLT(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::lt, val);
        }
        ...
        M_MODEL &whereLE(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::le, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereLE(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::le, val);
        }
        ...
        M_MODEL &whereNQ(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::nq, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereNQ(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::nq, val);
        }
        ...
        M_MODEL &whereNE(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::nq, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereNE(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::nq, val);
        }
        ...
        M_MODEL &whereLike(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::like, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereLike(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::like, val);
        }
        ...
        M_MODEL &whereLikeLeft(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::llike, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereLikeLeft(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::llike, val);
        }
        ...
        M_MODEL &whereLikeRight(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::rlike, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereLikeRight(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::rlike, val);
        }
        ...
        M_MODEL &whereNotLike(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::nlike, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereNotLike(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::nlike, val);
        }
        ...
        M_MODEL &whereOrBT(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return whereOr(wq, orm::wq::bt, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereOrBT(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return whereOr(wq, orm::wq::bt, val);
        }
        ...
        M_MODEL &whereOrBE(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return whereOr(wq, orm::wq::be, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereOrBE(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return whereOr(wq, orm::wq::be, val);
        }
        ...
        M_MODEL &whereOrLT(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return whereOr(wq, orm::wq::lt, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereOrLT(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return whereOr(wq, orm::wq::lt, val);
        }
        ...
        M_MODEL &whereOrLE(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return whereOr(wq, orm::wq::le, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereOrLE(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return whereOr(wq, orm::wq::le, val);
        }
        ...
        M_MODEL &whereOrNQ(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return whereOr(wq, orm::wq::nq, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereOrNQ(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return whereOr(wq, orm::wq::nq, val);
        }
        ...
        M_MODEL &whereOrLike(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return whereOr(wq, orm::wq::like, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereOrLike(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return whereOr(wq, orm::wq::like, val);
        }
        ...
        M_MODEL &whereOrLikeLeft(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return whereOr(wq, orm::wq::llike, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereOrLikeLeft(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return whereOr(wq, orm::wq::llike, val);
        }
        ...
        M_MODEL &whereOrLikeRight(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return whereOr(wq, orm::wq::rlike, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereOrLikeRight(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return whereOr(wq, orm::wq::rlike, val);
        }
        ...
        M_MODEL &whereOrNotLike(orm::table_col<B_BASE, &fortune_info::col_names> wq, std::string_view val)
        {
            return whereOr(wq, orm::wq::nlike, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereOrNotLike(orm::table_col<B_BASE, &fortune_info::col_names> wq, _SQL_Value val)
        {
            return whereOr(wq, orm::wq::nlike, val);
        }
        ...
        M_MODEL &desc(fortune_info::cols field, fortune_info::cols field2)
        {
        ...
        M_MODEL &desc(orm::table_col<B_BASE, &fortune_info::col_names> field1, orm::table_col<B_BASE, &fortune_info::col_names> field2)
        {
        ...
        M_MODEL &asc(fortune_info::cols field, fortune_info::cols field2)
        {
            ordersql.append(" ORDER BY ");
            switch (field)
            {
        ...
        M_MODEL &asc(orm::table_col<B_BASE, &fortune_info::col_names> field1, orm::table_col<B_BASE, &fortune_info::col_names> field2)
        {
        ...
        M_MODEL &asc(fortune_info::cols field)
        {
            ordersql.append(" ORDER BY ");
            switch (field)
            {
        ...
        M_MODEL &order(orm::table_col<B_BASE, &fortune_info::col_names> wq, const std::string &asc_or_desc)
        {
            ordersql.append(" ORDER BY ");
            ordersql.append(wq);
            ordersql.append(" ");
        ...
        M_MODEL &asc(orm::table_col<B_BASE, &fortune_info::col_names> wq)
        {
        ...
        M_MODEL &desc(orm::table_col<B_BASE, &fortune_info::col_names> wq)
        {
        ...
        M_MODEL &having(orm::table_col<B_BASE, &fortune_info::col_names> wq)
        {
        ...
        M_MODEL &group(fortune_info::cols field)
        {
        ...
        M_MODEL &group(orm::table_col<B_BASE, &fortune_info::col_names> wq)
        {
            groupsql.append(" GROUP BY ");
            groupsql.append(wq);
            return *mod;
        ...
        {
            model_meta_cache<fortune_info::meta> &data_cache = model_meta_cache<fortune_info::meta>::getinstance();
            data_cache.remove_exptime();

            model_meta_cache<std::vector<fortune_info::meta>> &record_cache = model_meta_cache<std::vector<fortune_info::meta>>::getinstance();
        ...
        bool save_data_cache(const std::string &cache_key_name, const fortune_info::meta &cache_data, int exp_time = 0)
        {
            model_meta_cache<fortune_info::meta> &temp_cache = model_meta_cache<fortune_info::meta>::getinstance();
        ...
        bool save_cache(std::size_t cache_key_name, const std::vector<fortune_info::meta> &cache_data, int exp_time = 0)
        {
            model_meta_cache<std::vector<fortune_info::meta>> &temp_cache = model_meta_cache<std::vector<fortune_info::meta>>::getinstance();
            temp_cache.save(cache_key_name, cache_data, exp_time);
            return true;
        }
        bool save_cache(const std::string cache_key_name, const std::vector<fortune_info::meta> &cache_data, int exp_time = 0)
        {
            model_meta_cache<std::vector<fortune_info::meta>> &temp_cache = model_meta_cache<std::vector<fortune_info::meta>>::getinstance();
            std::size_t sqlhashid                                            = std::hash<std::string>{}(cache_key_name);
            temp_cache.save(sqlhashid, cache_data, exp_time);
        ...
        bool save_vector_cache(const std::string cache_key_name, const std::vector<fortune_info::meta> &cache_data, int exp_time = 0)
        {
            model_meta_cache<std::vector<fortune_info::meta>> &temp_cache = model_meta_cache<std::vector<fortune_info::meta>>::getinstance();
            std::size_t sqlhashid                                            = std::hash<std::string>{}(cache_key_name);
            temp_cache.save(sqlhashid, cache_data, exp_time);
        ...
        bool save_cache(const std::string cache_key_name, const fortune_info::meta &cache_data, int exp_time = 0)
        {
            model_meta_cache<fortune_info::meta> &temp_cache = model_meta_cache<fortune_info::meta>::getinstance();
            std::size_t sqlhashid                               = std::hash<std::string>{}(cache_key_name);
            temp_cache.save(sqlhashid, cache_data, exp_time);
        ...
        std::tuple<unsigned int, unsigned long long> insert(fortune_info::meta &insert_data)
        {
            effect_num = 0;
        ...
        asio::awaitable<std::tuple<unsigned int, unsigned long long>> async_insert(fortune_info::meta &insert_data)
        {
            effect_num = 0;
            sqlstring  = B_BASE::make_data_insert_sql(insert_data);
        ...
        std::tuple<unsigned int, unsigned long long> insert(std::vector<fortune_info::meta> &insert_data)
        {
            effect_num = 0;
        ...
        asio::awaitable<std::tuple<unsigned int, unsigned long long>> async_insert(std::vector<fortune_info::meta> &insert_data)
        {
            effect_num = 0;
            sqlstring  = B_BASE::make_vector_insert_sql(insert_data);
        ...
        M_MODEL &set_data(fortune_info::meta indata)
        {
            B_BASE::data = indata;
            return *mod;
        }
      ...
      public:
        ...
        template <typename T>
        M_MODEL &AND(orm::table_col<B_BASE, &fortune_info::col_names> field, orm::wq opwq, T val)
        {
            orm_where_sql_t item;
            item.pre_op  = wheresql.empty() ? 0 : 1;
            item.op_type = opwq;
        ...
        template <typename T>
        M_MODEL &OR(orm::table_col<B_BASE, &fortune_info::col_names> field, orm::wq opwq, T val)
        {
            orm_where_sql_t item;
            item.pre_op  = wheresql.empty() ? 0 : 2;
            item.op_type = opwq;
