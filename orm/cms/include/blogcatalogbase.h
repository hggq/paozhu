...
*本文件为自动生成 Sat, 23 Nov 2024 23:59:11 GMT
***/
#include <iostream>
#include <cstdio>
#include <sstream>
...
const std::array<std::string,5> colnames={"bid","userid","dateid","articlenum","languageid"};
const std::array<unsigned char,5> colnamestype= {3,3,3,3,3};
std::string tablename="blogcatalog";
std::string modelname="Blogcatalog";
...
break;
	...
	case 3:
		 try{
			data.articlenum=std::stoul(_row[i]);
		}catch (...) { 
			data.articlenum=0;
			 }
			break;
	case 4:
		 try{
			data.languageid=std::stoul(_row[i]);
		}catch (...) { 
			data.languageid=0;
			 }
			break;
	...
	case 2:
		 try{
			metatemp.dateid=std::stoul(_row[i]);
		}catch (...) { 
			metatemp.dateid=0;
			 }
			break;
	case 3:
		 try{
			metatemp.articlenum=std::stoul(_row[i]);
		}catch (...) { 
			metatemp.articlenum=0;
			 }
			break;
	case 4:
		 try{
			metatemp.languageid=std::stoul(_row[i]);
		}catch (...) { 
			metatemp.languageid=0;
			 }
			break;
	default:
		 { }
