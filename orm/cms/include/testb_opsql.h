...
M_MODEL& inTid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inTid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inTid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninTid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninTid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninTid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqTid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqTid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inTid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inTid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inTid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninTid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninTid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninTid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btTid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beTid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltTid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leTid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inScore(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inScore(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inScore(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninScore(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninScore(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninScore(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqScore(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqScore(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inScore(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inScore(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inScore(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inScore(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninScore(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninScore(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninScore(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninScore(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btScore(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beScore(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltScore(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leScore(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
