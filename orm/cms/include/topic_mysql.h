        ...
        void assign_field_value(unsigned char index_pos, unsigned char *result_temp_data, unsigned int value_size, topic_info::meta &data_temp)
    {
        switch(index_pos)
        {
            ...
            for( ; i< value_size; i++)
            {
                ...
                if(issig)
                {
                    data_temp.cateid = -data_temp.cateid  ;
                }
            }
            break;
                case 4:
            ...
            for( ; i< value_size; i++)
            {
                ...
                if(issig)
                {
                    data_temp.sorttype = -data_temp.sorttype  ;
                }
            }
            break;
                case 5:
            ...
            for( ; i< value_size; i++)
            {
                ...
                if(issig)
                {
                    data_temp.languagetype = -data_temp.languagetype  ;
                }
            }
            break;
                case 6:
            ...
            for( ; i< value_size; i++)
            {
                ...
                if(issig)
                {
                    data_temp.isside = -data_temp.isside  ;
                }
            }
            break;
                case 8:
            ...
            for( ; i< value_size; i++)
            {
                ...
                if(issig)
                {
                    data_temp.accesscode = -data_temp.accesscode  ;
                }
            }
            break;
