...
const std::array<std::string,8> colnames={"cid","userid","level","parentid","name","isview","sortid","imgurl"};
const std::array<unsigned char,8> colnamestype= {3,3,3,3,253,1,3,253};
...
break;
	...
	case 2:
		 try{
			metatemp.level=std::stoul(_row[i]);
		}catch (...) { 
			metatemp.level=0;
			 }
			break;
