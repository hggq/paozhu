...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninLgid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninLogtype(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inLogtype(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninLogtype(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& nullUsername()
	{
        ...
        wheresql.append(" username IS NULL ");
...
M_MODEL& nnullUsername()
	{
        ...
        wheresql.append(" username IS NOT NULL ");
...
M_MODEL& nullAddtime()
	{
        ...
        wheresql.append(" addtime IS NULL ");
...
M_MODEL& nnullAddtime()
	{
        ...
        wheresql.append(" addtime IS NOT NULL ");
...
M_MODEL& nnullAddip()
	{
        ...
        wheresql.append(" addip IS NOT NULL ");
...
M_MODEL& nullAddregion()
	{
        ...
        wheresql.append(" addregion IS NULL ");
...
M_MODEL& nnullAddregion()
	{
        ...
        wheresql.append(" addregion IS NOT NULL ");
...
M_MODEL& nullLoginstate()
	{
        ...
        wheresql.append(" loginstate IS NULL ");
...
M_MODEL& nnullLoginstate()
	{
        ...
        wheresql.append(" loginstate IS NOT NULL ");
...
M_MODEL& nnullAgent()
	{
        ...
        wheresql.append(" agent IS NOT NULL ");
...
M_MODEL& or_leUrlpath(T val)
	{
        ...
        template <typename T2>
        M_MODEL &where(logininfo_info::cols field1, orm::wq opwq, T2 &&field2)
        {
            if (wheresql.empty())
            {
            }
        ...
        template <typename T2>
        M_MODEL &whereOr(logininfo_info::cols field1, orm::wq opwq, T2 &&field2)
        {
            if (wheresql.empty())
            {
            }
