...
M_MODEL& ornotnullUrlpath()
	{return whereOrNotNull(B_BASE::cols::urlpath);
        ...
        template <typename T>
        M_MODEL &where(orm::table_col<B_BASE, &logininfo_info::col_names> wq, T &&val)
        {
        ...
        template <typename T>
        M_MODEL &whereOr(orm::table_col<B_BASE, &logininfo_info::col_names> wq, T &&val)
        {
        ...
        M_MODEL &whereIn(orm::table_col<B_BASE, &logininfo_info::col_names> wq, const std::vector<std::string> &a)
        {
            return whereIn(wq, orm::wq::in, a);
        }
        // 2 参数旧版兼容: whereIn("id", "1,2,3") = whereIn("id", split_csv("1,2,3"))
        M_MODEL &whereIn(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view csv_val)
        {
        ...
        template <typename T>
        M_MODEL &whereIn(orm::table_col<B_BASE, &logininfo_info::col_names> wq, const std::vector<T> &a)
        {
        ...
        M_MODEL &whereNotIn(orm::table_col<B_BASE, &logininfo_info::col_names> wq, const std::vector<std::string> &a)
        {
            return whereIn(wq, orm::wq::notin, a);
        }

        M_MODEL &whereOrIn(orm::table_col<B_BASE, &logininfo_info::col_names> wq, const std::vector<std::string> &a)
        {
            return whereOrIn(wq, orm::wq::in, a);
        }

        M_MODEL &whereOrNotIn(orm::table_col<B_BASE, &logininfo_info::col_names> wq, const std::vector<std::string> &a)
        {
        ...
        M_MODEL &whereNull(orm::table_col<B_BASE, &logininfo_info::col_names> wq)
        {
            orm_where_sql_t item;
            item.pre_op  = wheresql.empty() ? 0 : 1;
            item.op_type = orm::wq::isnull;
        ...
        M_MODEL &whereOrNull(orm::table_col<B_BASE, &logininfo_info::col_names> wq)
        {
            orm_where_sql_t item;
            item.pre_op  = wheresql.empty() ? 0 : 2;
            item.op_type = orm::wq::isnull;
        ...
        M_MODEL &whereNotNull(orm::table_col<B_BASE, &logininfo_info::col_names> wq)
        {
            orm_where_sql_t item;
            item.pre_op  = wheresql.empty() ? 0 : 1;
            item.op_type = orm::wq::notnull;
        ...
        M_MODEL &whereOrNotNull(orm::table_col<B_BASE, &logininfo_info::col_names> wq)
        {
            orm_where_sql_t item;
            item.pre_op  = wheresql.empty() ? 0 : 2;
            item.op_type = orm::wq::notnull;
        ...
        M_MODEL &whereEQ(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::eq, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereEQ(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::eq, val);
        }
        ...
        M_MODEL &whereAnd(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::eq, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereAnd(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::eq, val);
        }
        ...
        M_MODEL &whereBT(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::bt, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereBT(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::bt, val);
        }
        ...
        M_MODEL &whereGT(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::bt, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereGT(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::bt, val);
        }
        ...
        M_MODEL &whereBE(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::be, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereBE(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::be, val);
        }
        ...
        M_MODEL &whereGE(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::be, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereGE(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::be, val);
        }
        ...
        M_MODEL &whereLT(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::lt, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereLT(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::lt, val);
        }
        ...
        M_MODEL &whereLE(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::le, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereLE(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::le, val);
        }
        ...
        M_MODEL &whereNQ(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::nq, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereNQ(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::nq, val);
        }
        ...
        M_MODEL &whereNE(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::nq, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereNE(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::nq, val);
        }
        ...
        M_MODEL &whereLike(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::like, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereLike(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::like, val);
        }
        ...
        M_MODEL &whereLikeLeft(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::llike, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereLikeLeft(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::llike, val);
        }
        ...
        M_MODEL &whereLikeRight(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::rlike, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereLikeRight(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::rlike, val);
        }
        ...
        M_MODEL &whereNotLike(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return where(wq, orm::wq::nlike, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereNotLike(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return where(wq, orm::wq::nlike, val);
        }
        ...
        M_MODEL &whereOrBT(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return whereOr(wq, orm::wq::bt, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereOrBT(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return whereOr(wq, orm::wq::bt, val);
        }
        ...
        M_MODEL &whereOrBE(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return whereOr(wq, orm::wq::be, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereOrBE(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return whereOr(wq, orm::wq::be, val);
        }
        ...
        M_MODEL &whereOrLT(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return whereOr(wq, orm::wq::lt, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereOrLT(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return whereOr(wq, orm::wq::lt, val);
        }
        ...
        M_MODEL &whereOrLE(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return whereOr(wq, orm::wq::le, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereOrLE(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return whereOr(wq, orm::wq::le, val);
        }
        ...
        M_MODEL &whereOrNQ(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return whereOr(wq, orm::wq::nq, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereOrNQ(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return whereOr(wq, orm::wq::nq, val);
        }
        ...
        M_MODEL &whereOrLike(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return whereOr(wq, orm::wq::like, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereOrLike(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return whereOr(wq, orm::wq::like, val);
        }
        ...
        M_MODEL &whereOrLikeLeft(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return whereOr(wq, orm::wq::llike, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereOrLikeLeft(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return whereOr(wq, orm::wq::llike, val);
        }
        ...
        M_MODEL &whereOrLikeRight(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return whereOr(wq, orm::wq::rlike, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereOrLikeRight(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return whereOr(wq, orm::wq::rlike, val);
        }
        ...
        M_MODEL &whereOrNotLike(orm::table_col<B_BASE, &logininfo_info::col_names> wq, std::string_view val)
        {
            return whereOr(wq, orm::wq::nlike, val);
        }

        template <typename _SQL_Value>
        M_MODEL &whereOrNotLike(orm::table_col<B_BASE, &logininfo_info::col_names> wq, _SQL_Value val)
        {
            return whereOr(wq, orm::wq::nlike, val);
        }
        ...
        M_MODEL &asc(orm::table_col<B_BASE, &logininfo_info::col_names> field1, orm::table_col<B_BASE, &logininfo_info::col_names> field2)
        {
        ...
        M_MODEL &asc(logininfo_info::cols field, logininfo_info::cols field2)
        {
            ordersql.append(" ORDER BY ");
            switch (field)
            {
        ...
        M_MODEL &desc(logininfo_info::cols field, logininfo_info::cols field2)
        {
        ...
        M_MODEL &desc(orm::table_col<B_BASE, &logininfo_info::col_names> field1, orm::table_col<B_BASE, &logininfo_info::col_names> field2)
        {
        ...
        M_MODEL &order(orm::table_col<B_BASE, &logininfo_info::col_names> wq, const std::string &asc_or_desc)
        {
            ordersql.append(" ORDER BY ");
            ordersql.append(wq);
            ordersql.append(" ");
        ...
        M_MODEL &asc(orm::table_col<B_BASE, &logininfo_info::col_names> wq)
        {
        ...
        M_MODEL &desc(orm::table_col<B_BASE, &logininfo_info::col_names> wq)
        {
        ...
        M_MODEL &having(orm::table_col<B_BASE, &logininfo_info::col_names> wq)
        {
        ...
        M_MODEL &group(orm::table_col<B_BASE, &logininfo_info::col_names> wq)
        {
            groupsql.append(" GROUP BY ");
            groupsql.append(wq);
            return *mod;
        ...
        template <typename T>
        M_MODEL &AND(orm::table_col<B_BASE, &logininfo_info::col_names> field, orm::wq opwq, T val)
        {
            orm_where_sql_t item;
            item.pre_op  = wheresql.empty() ? 0 : 1;
            item.op_type = opwq;
        ...
        template <typename T>
        M_MODEL &OR(orm::table_col<B_BASE, &logininfo_info::col_names> field, orm::wq opwq, T val)
        {
            orm_where_sql_t item;
            item.pre_op  = wheresql.empty() ? 0 : 2;
            item.op_type = opwq;
