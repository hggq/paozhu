...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninXmeetid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inXmeetid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninXmeetid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inXpjid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninXpjid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninXtaskid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inXtaskid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninXtaskid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& nullZhuchi()
	{
        ...
        wheresql.append(" zhuchi IS NULL ");
...
M_MODEL& nnullZhuchi()
	{
        ...
        wheresql.append(" zhuchi IS NOT NULL ");
...
M_MODEL& nnullJilu()
	{
        ...
        wheresql.append(" jilu IS NOT NULL ");
...
M_MODEL& nullMeetnotice()
	{
        ...
        wheresql.append(" meetnotice IS NULL ");
...
M_MODEL& nnullMeetnotice()
	{
        ...
        wheresql.append(" meetnotice IS NOT NULL ");
...
M_MODEL& nullMeetfiles()
	{
        ...
        wheresql.append(" meetfiles IS NULL ");
...
M_MODEL& nnullMeetfiles()
	{
        ...
        wheresql.append(" meetfiles IS NOT NULL ");
...
M_MODEL& nullMeettime()
	{
        ...
        wheresql.append(" meettime IS NULL ");
...
M_MODEL& nnullMeettime()
	{
        ...
        wheresql.append(" meettime IS NOT NULL ");
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninRegdate(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inRegdate(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninRegdate(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inExpecttime(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninExpecttime(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inExpecttime(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninExpecttime(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninEndtime(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inEndtime(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninEndtime(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& nullPresents()
	{
        ...
        wheresql.append(" presents IS NULL ");
...
M_MODEL& nnullPresents()
	{
        ...
        wheresql.append(" presents IS NOT NULL ");
...
M_MODEL& nullPostresult()
	{
        ...
        wheresql.append(" postresult IS NULL ");
...
M_MODEL& nnullPostresult()
	{
        ...
        wheresql.append(" postresult IS NOT NULL ");
...
M_MODEL& nullPostfiles()
	{
        ...
        wheresql.append(" postfiles IS NULL ");
...
M_MODEL& nnullPostfiles()
	{
        ...
        wheresql.append(" postfiles IS NOT NULL ");
...
M_MODEL& nullJiluphoto()
	{
        ...
        wheresql.append(" jiluphoto IS NULL ");
...
M_MODEL& nnullJiluphoto()
	{
        ...
        wheresql.append(" jiluphoto IS NOT NULL ");
...
M_MODEL& or_leJiluphoto(T val)
	{
        ...
        template <typename T2>
        M_MODEL &where(xmeet_info::cols field, orm::wq opwq, T2 &&value)
        {
            if (wheresql.empty())
            {
            }
        ...
        template <typename T2>
        M_MODEL &whereOr(xmeet_info::cols field, orm::wq opwq, T2 &&value)
        {
            if (wheresql.empty())
            {
            }
