...
M_MODEL& inRolepermsid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
        ...
        wheresql.append(" rolepermsid IN('");
...
M_MODEL& inRolepermsid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inRolepermsid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inRolepermsid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninRolepermsid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
        ...
        wheresql.append(" rolepermsid NOT IN('");
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninRolepermsid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninRolepermsid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninRolepermsid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqRolepermsid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqRolepermsid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inRolepermsid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inRolepermsid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inRolepermsid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inRolepermsid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninRolepermsid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninRolepermsid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninRolepermsid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninRolepermsid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btRolepermsid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beRolepermsid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltRolepermsid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leRolepermsid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_eqRolepermsid(T val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_nqRolepermsid(T val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_btRolepermsid(T val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_beRolepermsid(T val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ltRolepermsid(T val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_leRolepermsid(T val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leSortid(T val)
	{
        ...
        template <typename T2>
        M_MODEL &where(sysroleperms_info::cols field, orm::wq opwq, T2 &&value)
        {
            if (wheresql.empty())
            {
            }
        ...
        template <typename T2>
        M_MODEL &whereOr(sysroleperms_info::cols field, orm::wq opwq, T2 &&value)
        {
            if (wheresql.empty())
            {
            }
