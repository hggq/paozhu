...
static constexpr std::array<std::string,9> col_names={"brandid","userid","topicid","sortid","logo","title","name","introduce","detailcontent"};
...
static constexpr std::string modelname="Brand";
