...
{ /*tagnamespace_replace*/
    ...
    class xmeet_mysql : public B_BASE
    {
      public:
        ...
        void assign_field_value(unsigned char index_pos, unsigned char *result_temp_data, unsigned int value_size, xmeet_info::meta &data_temp)
    {
        switch(index_pos)
        {
            case 0:
            ...
            data_temp.xtaskid=0;
                    ...
                    {
                        decltype(data_temp.xtaskid) _tmp{};
                        auto result = std::from_chars(
                            reinterpret_cast<const char*>(result_temp_data),
                            reinterpret_cast<const char*>(result_temp_data) + value_size,
                            _tmp);
                        if (result.ec == std::errc()) {
                            data_temp.xtaskid = _tmp;
                        }
                    }
            break;
                case 4:
            ...
            data_temp.expecttime=0;
                    ...
                    {
                        decltype(data_temp.expecttime) _tmp{};
                        auto result = std::from_chars(
                            reinterpret_cast<const char*>(result_temp_data),
                            reinterpret_cast<const char*>(result_temp_data) + value_size,
                            _tmp);
                        if (result.ec == std::errc()) {
                            data_temp.expecttime = _tmp;
                        }
                    }
            break;
                case 14:
            data_temp.endtime=0;
                    ...
                    {
                        decltype(data_temp.endtime) _tmp{};
                        auto result = std::from_chars(
                            reinterpret_cast<const char*>(result_temp_data),
                            reinterpret_cast<const char*>(result_temp_data) + value_size,
                            _tmp);
                        if (result.ec == std::errc()) {
                            data_temp.endtime = _tmp;
                        }
                    }
            break;
                case 15:
