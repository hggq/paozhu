...
M_MODEL& inHbid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inHbid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inHbid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninHbid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninHbid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninHbid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqHbid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqHbid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inHbid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inHbid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inHbid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninHbid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninHbid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninHbid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninHbid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btHbid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beHbid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltHbid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leHbid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inJsonconfig(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inJsonconfig(const std::vector<std::string> &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inJsonconfig(const std::vector<T> &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninJsonconfig(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
        ...
        wheresql.append(" jsonconfig NOT IN('");
				wheresql.append(B_BASE::stringaddslash(val));
				wheresql.push_back('\'');
				wheresql.push_back(')');
...
M_MODEL& ninJsonconfig(const std::vector<std::string> &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninJsonconfig(const std::vector<T> &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& likeJsonconfig(const std::string &val)
	{
        ...
        wheresql.append(" jsonconfig LIKE '%");
				wheresql.append(B_BASE::stringaddslash(val));
				wheresql.append("%'");
...
M_MODEL& l_likeJsonconfig(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& r_likeJsonconfig(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqJsonconfig(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqJsonconfig(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inJsonconfig(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inJsonconfig(const std::vector<std::string> &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inJsonconfig(const std::vector<T> &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninJsonconfig(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninJsonconfig(const std::vector<std::string> &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninJsonconfig(const std::vector<T> &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_likeJsonconfig(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& orl_likeJsonconfig(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& orr_likeJsonconfig(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btJsonconfig(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beJsonconfig(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltJsonconfig(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leJsonconfig(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inViewtype(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inViewtype(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inViewtype(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inViewtype(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninViewtype(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
        ...
        wheresql.append(" viewtype NOT IN('");
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninViewtype(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninViewtype(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninViewtype(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqViewtype(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqViewtype(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inViewtype(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inViewtype(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inViewtype(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inViewtype(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninViewtype(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninViewtype(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninViewtype(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninViewtype(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btViewtype(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beViewtype(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltViewtype(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leViewtype(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inGettype(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inGettype(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inGettype(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninGettype(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
        ...
        wheresql.append(" gettype NOT IN('");
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninGettype(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninGettype(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninGettype(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqGettype(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqGettype(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inGettype(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inGettype(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inGettype(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inGettype(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninGettype(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninGettype(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninGettype(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninGettype(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btGettype(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beGettype(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltGettype(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leGettype(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inRownum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inRownum(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inRownum(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninRownum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninRownum(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninRownum(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqRownum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqRownum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inRownum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inRownum(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inRownum(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inRownum(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninRownum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninRownum(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninRownum(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninRownum(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btRownum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beRownum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltRownum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leRownum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inWidth(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inWidth(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inWidth(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninWidth(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninWidth(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninWidth(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqWidth(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqWidth(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inWidth(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inWidth(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inWidth(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inWidth(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninWidth(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninWidth(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninWidth(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninWidth(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btWidth(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beWidth(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltWidth(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leWidth(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inHeight(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inHeight(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inHeight(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninHeight(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninHeight(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninHeight(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqHeight(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqHeight(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inHeight(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inHeight(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inHeight(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inHeight(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninHeight(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninHeight(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninHeight(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninHeight(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btHeight(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beHeight(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltHeight(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leHeight(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inStrlength(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inStrlength(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inStrlength(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inStrlength(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninStrlength(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
        ...
        wheresql.append(" strlength NOT IN('");
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninStrlength(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninStrlength(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninStrlength(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqStrlength(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqStrlength(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inStrlength(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inStrlength(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inStrlength(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inStrlength(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninStrlength(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninStrlength(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninStrlength(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninStrlength(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btStrlength(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beStrlength(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltStrlength(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leStrlength(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leSortid(T val)
	{
        ...
        template <typename T2>
        M_MODEL &where(homeblock_info::cols field, orm::wq opwq, T2 &&value)
        {
            if (wheresql.empty())
            {
            }
        ...
        template <typename T2>
        M_MODEL &whereOr(homeblock_info::cols field, orm::wq opwq, T2 &&value)
        {
            if (wheresql.empty())
            {
            }
