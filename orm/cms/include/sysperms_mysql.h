...
{ /*tagnamespace_replace*/
    ...
    class sysperms_mysql : public B_BASE
    {
      public:
        sysperms_mysql(const std::string &tag) : dbtag(tag)
        {
        ...
        sysperms_mysql() : dbtag(B_BASE::_rmstag)
        {
            std::map<std::string, std::shared_ptr<orm_conn_pool>> &conn_pool_obj = get_orm_conn_pool_obj();
            auto iter                                                            = conn_pool_obj.find(dbtag);
            if (iter != conn_pool_obj.end())
        ...
        void assign_field_value(unsigned char index_pos, unsigned char *result_temp_data, unsigned int value_size, sysperms_info::meta &data_temp)
    {
        switch(index_pos)
        {
            case 0:
            ...
            data_temp.urlname.resize(value_size);
            
            std::memcpy(data_temp.urlname.data(), result_temp_data, value_size);
            break;
                case 5:
            ...
            for( ; i< value_size; i++)
            {
                ...
                data_temp.permscode= data_temp.permscode * 10 + (result_temp_data[i]-'0');
                }   
                if(i>36)
                {
                    break;
                ...
                if(issig)
                {
                    data_temp.permscode = -data_temp.permscode  ;
                }
            }
            break;
                case 8:
            ...
            for( ; i< value_size; i++)
            {
                ...
                data_temp.readonly= data_temp.readonly * 10 + (result_temp_data[i]-'0');
                }   
                if(i>36)
                {
                    break;
                ...
                if(issig)
                {
                    data_temp.readonly = -data_temp.readonly  ;
                }
            }
            break;
                case 9:
