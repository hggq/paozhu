...
M_MODEL& inBid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inBid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inBid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninBid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninBid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninBid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqBid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqBid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inBid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inBid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inBid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninBid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninBid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninBid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btBid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beBid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltBid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leBid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inDateid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inDateid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inDateid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninDateid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninDateid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninDateid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqDateid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqDateid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inDateid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inDateid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inDateid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inDateid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninDateid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninDateid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninDateid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninDateid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btDateid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beDateid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltDateid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leDateid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inArticlenum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inArticlenum(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inArticlenum(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inArticlenum(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninArticlenum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
        ...
        wheresql.append(" articlenum NOT IN('");
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninArticlenum(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninArticlenum(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninArticlenum(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqArticlenum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqArticlenum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inArticlenum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inArticlenum(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inArticlenum(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inArticlenum(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninArticlenum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninArticlenum(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninArticlenum(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninArticlenum(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btArticlenum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beArticlenum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltArticlenum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leArticlenum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inLanguageid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inLanguageid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inLanguageid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inLanguageid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninLanguageid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
        ...
        wheresql.append(" languageid NOT IN('");
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninLanguageid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninLanguageid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninLanguageid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqLanguageid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqLanguageid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inLanguageid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inLanguageid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inLanguageid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inLanguageid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninLanguageid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninLanguageid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninLanguageid(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninLanguageid(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btLanguageid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beLanguageid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltLanguageid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leLanguageid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leLanguageid(T val)
	{
        ...
        template <typename T2>
        M_MODEL &where(blogcatalog_info::cols field, orm::wq opwq, T2 &&value)
        {
            if (wheresql.empty())
            {
            }
        ...
        template <typename T2>
        M_MODEL &whereOr(blogcatalog_info::cols field, orm::wq opwq, T2 &&value)
        {
            if (wheresql.empty())
            {
            }
