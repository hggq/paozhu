...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inBegindate(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninBegindate(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inBegindate(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninBegindate(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& nullRegdate()
	{
        ...
        wheresql.append(" regdate IS NULL ");
...
M_MODEL& nnullRegdate()
	{
        ...
        wheresql.append(" regdate IS NOT NULL ");
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inLoginnum(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninLoginnum(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inLoginnum(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninLoginnum(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& nullBasesitepath()
	{
        ...
        wheresql.append(" basesitepath IS NULL ");
...
M_MODEL& nnullBasesitepath()
	{
        ...
        wheresql.append(" basesitepath IS NOT NULL ");
...
M_MODEL& or_leBasesitepath(T val)
	{
        ...
        template <typename T2>
        M_MODEL &where(superadmin_info::cols field, orm::wq opwq, T2 &&value)
        {
            if (wheresql.empty())
            {
            }
        ...
        template <typename T2>
        M_MODEL &whereOr(superadmin_info::cols field, orm::wq opwq, T2 &&value)
        {
            if (wheresql.empty())
            {
            }
