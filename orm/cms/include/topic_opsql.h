...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inCateid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninCateid(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inSorttype(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninSorttype(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inSorttype(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninSorttype(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inLanguagetype(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninLanguagetype(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inLanguagetype(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninLanguagetype(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inIsside(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninIsside(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& nullTwotitle()
	{
        ...
        wheresql.append(" twotitle IS NULL ");
...
M_MODEL& nnullTwotitle()
	{
        ...
        wheresql.append(" twotitle IS NOT NULL ");
...
M_MODEL& nullTemplatename()
	{
        ...
        wheresql.append(" templatename IS NULL ");
...
M_MODEL& nnullTemplatename()
	{
        ...
        wheresql.append(" templatename IS NOT NULL ");
...
M_MODEL& nnullUrl()
	{
        ...
        wheresql.append(" url IS NOT NULL ");
...
M_MODEL& nullTopimg()
	{
        ...
        wheresql.append(" topimg IS NULL ");
...
M_MODEL& nnullTopimg()
	{
        ...
        wheresql.append(" topimg IS NOT NULL ");
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inAccesscode(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninAccesscode(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inAccesscode(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninAccesscode(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leAccesscode(T val)
	{
        ...
        template <typename T2>
        M_MODEL &where(topic_info::cols field, orm::wq opwq, T2 &&value)
        {
            if (wheresql.empty())
            {
            }
        ...
        template <typename T2>
        M_MODEL &whereOr(topic_info::cols field, orm::wq opwq, T2 &&value)
        {
            if (wheresql.empty())
            {
            }
