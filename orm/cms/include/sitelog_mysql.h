        ...
        void assign_field_value(unsigned char index_pos, unsigned char *result_temp_data, unsigned int value_size, sitelog_info::meta &data_temp)
    {
        switch(index_pos)
        {
            ...
            data_temp.memberid=0;
                    ...
                    {
                        decltype(data_temp.memberid) _tmp{};
                        auto result = std::from_chars(
                            reinterpret_cast<const char*>(result_temp_data),
                            reinterpret_cast<const char*>(result_temp_data) + value_size,
                            _tmp);
                        if (result.ec == std::errc()) {
                            data_temp.memberid = _tmp;
                        }
                    }
            break;
                case 3:
            data_temp.ipport=0;
                    ...
                    {
                        decltype(data_temp.ipport) _tmp{};
                        auto result = std::from_chars(
                            reinterpret_cast<const char*>(result_temp_data),
                            reinterpret_cast<const char*>(result_temp_data) + value_size,
                            _tmp);
                        if (result.ec == std::errc()) {
                            data_temp.ipport = _tmp;
                        }
                    }
            break;
                case 4:
            data_temp.httpv=0;
                    ...
                    {
                        decltype(data_temp.httpv) _tmp{};
                        auto result = std::from_chars(
                            reinterpret_cast<const char*>(result_temp_data),
                            reinterpret_cast<const char*>(result_temp_data) + value_size,
                            _tmp);
                        if (result.ec == std::errc()) {
                            data_temp.httpv = _tmp;
                        }
                    }
            break;
                case 5:
