    ...
    std::string getstrCol(std::string keyname, [[maybe_unused]] bool isyinhao = false)
    {
        ...
        for (auto &iter : record)
        {
            ...
            case 5:
                if (isyinhao)
                {
                    a << jsonaddslash(iter.sitedomain);
                }
                else
                {
                    a << iter.sitedomain;
            ...
            case 10:
                if (isyinhao)
                {
                    a << jsonaddslash(iter.footscript);
                }
                else
                {
                    a << iter.footscript;
            ...
            case 11:
                if (isyinhao)
                {
                    a << jsonaddslash(iter.headscript);
                }
                else
                {
                    a << iter.headscript;
            ...
            case 14:
                if (isyinhao)
                {
                    a << jsonaddslash(iter.contactman);
                }
                else
                {
                    a << iter.contactman;
            ...
            case 23:
                if (isyinhao)
                {
                    a << jsonaddslash(iter.companyname);
                }
                else
                {
                    a << iter.companyname;
            ...
            case 25:
                if (isyinhao)
                {
                    a << jsonaddslash(iter.linkmobile);
                }
                else
                {
                    a << iter.linkmobile;
            ...
            case 26:
                if (isyinhao)
                {
                    a << jsonaddslash(iter.linkaddress);
                }
                else
                {
                    a << iter.linkaddress;
