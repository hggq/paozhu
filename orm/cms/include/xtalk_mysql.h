...
{ /*tagnamespace_replace*/
    ...
    class xtalk_mysql : public B_BASE
    {
      public:
        ...
        void assign_field_value(unsigned char index_pos, unsigned char *result_temp_data, unsigned int value_size, xtalk_info::meta &data_temp)
    {
        switch(index_pos)
        {
            case 0:
            ...
            data_temp.taskid=0;
                    ...
                    {
                        decltype(data_temp.taskid) _tmp{};
                        auto result = std::from_chars(
                            reinterpret_cast<const char*>(result_temp_data),
                            reinterpret_cast<const char*>(result_temp_data) + value_size,
                            _tmp);
                        if (result.ec == std::errc()) {
                            data_temp.taskid = _tmp;
                        }
                    }
            break;
                case 4:
            data_temp.projectid=0;
                    ...
                    {
                        decltype(data_temp.projectid) _tmp{};
                        auto result = std::from_chars(
                            reinterpret_cast<const char*>(result_temp_data),
                            reinterpret_cast<const char*>(result_temp_data) + value_size,
                            _tmp);
                        if (result.ec == std::errc()) {
                            data_temp.projectid = _tmp;
                        }
                    }
            break;
                case 5:
            ...
            data_temp.isdelete=0;
                    ...
                    {
                        decltype(data_temp.isdelete) _tmp{};
                        auto result = std::from_chars(
                            reinterpret_cast<const char*>(result_temp_data),
                            reinterpret_cast<const char*>(result_temp_data) + value_size,
                            _tmp);
                        if (result.ec == std::errc()) {
                            data_temp.isdelete = _tmp;
                        }
                    }
            break;
                case 7:
            ...
            data_temp.update_at=0;
                    ...
                    {
                        decltype(data_temp.update_at) _tmp{};
                        auto result = std::from_chars(
                            reinterpret_cast<const char*>(result_temp_data),
                            reinterpret_cast<const char*>(result_temp_data) + value_size,
                            _tmp);
                        if (result.ec == std::errc()) {
                            data_temp.update_at = _tmp;
                        }
                    }
            break;
                case 9:
            data_temp.islock=0;
                    ...
                    {
                        decltype(data_temp.islock) _tmp{};
                        auto result = std::from_chars(
                            reinterpret_cast<const char*>(result_temp_data),
                            reinterpret_cast<const char*>(result_temp_data) + value_size,
                            _tmp);
                        if (result.ec == std::errc()) {
                            data_temp.islock = _tmp;
                        }
                    }
            break;
                case 10:
            data_temp.replyid=0;
                    ...
                    {
                        decltype(data_temp.replyid) _tmp{};
                        auto result = std::from_chars(
                            reinterpret_cast<const char*>(result_temp_data),
                            reinterpret_cast<const char*>(result_temp_data) + value_size,
                            _tmp);
                        if (result.ec == std::errc()) {
                            data_temp.replyid = _tmp;
                        }
                    }
            break;
