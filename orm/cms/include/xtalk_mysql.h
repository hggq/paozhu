        ...
        void assign_field_value(unsigned char index_pos, unsigned char *result_temp_data, unsigned int value_size, xtalk_info::meta &data_temp)
    {
        switch(index_pos)
        {
            ...
            for( ; i< value_size; i++)
            {
                ...
                if(issig)
                {
                    data_temp.talkid = -data_temp.talkid  ;
                }
            }
            break;
                case 1:
            ...
            for( ; i< value_size; i++)
            {
                ...
                if(issig)
                {
                    data_temp.taskid = -data_temp.taskid  ;
                }
            }
            break;
                case 4:
            ...
            for( ; i< value_size; i++)
            {
                ...
                if(issig)
                {
                    data_temp.projectid = -data_temp.projectid  ;
                }
            }
            break;
                case 5:
            ...
            for( ; i< value_size; i++)
            {
                ...
                if(issig)
                {
                    data_temp.isdelete = -data_temp.isdelete  ;
                }
            }
            break;
                case 7:
            ...
            for( ; i< value_size; i++)
            {
                ...
                if(issig)
                {
                    data_temp.update_at = -data_temp.update_at  ;
                }
            }
            break;
                case 9:
            ...
            for( ; i< value_size; i++)
            {
                ...
                if(issig)
                {
                    data_temp.islock = -data_temp.islock  ;
                }
            }
            break;
                case 10:
            ...
            for( ; i< value_size; i++)
            {
                ...
                if(issig)
                {
                    data_temp.replyid = -data_temp.replyid  ;
                }
            }
            break;
