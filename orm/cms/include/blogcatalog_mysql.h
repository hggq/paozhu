...
{ /*tagnamespace_replace*/
    ...
    class blogcatalog_mysql : public B_BASE
    {
      public:
        blogcatalog_mysql(const std::string &tag) : dbtag(tag)
        {
        ...
        blogcatalog_mysql() : dbtag(B_BASE::_rmstag)
        {
            std::map<std::string, std::shared_ptr<orm_conn_pool>> &conn_pool_obj = get_orm_conn_pool_obj();
            auto iter                                                            = conn_pool_obj.find(dbtag);
            if (iter != conn_pool_obj.end())
        ...
        void assign_field_value(unsigned char index_pos, unsigned char *result_temp_data, unsigned int value_size, blogcatalog_info::meta &data_temp)
    {
        switch(index_pos)
        {
            case 0:
            ...
            for( ; i< value_size; i++)
            {
                ...
                data_temp.bid= data_temp.bid * 10 + (result_temp_data[i]-'0');
                }   
                if(i>36)
                {
                    break;
            ...
            for( ; i< value_size; i++)
            {
                ...
                data_temp.dateid= data_temp.dateid * 10 + (result_temp_data[i]-'0');
                }   
                if(i>36)
                {
                    break;
                ...
                if(issig)
                {
                    data_temp.dateid = -data_temp.dateid  ;
                }
            }
            break;
                case 3:
            ...
            for( ; i< value_size; i++)
            {
                ...
                data_temp.articlenum= data_temp.articlenum * 10 + (result_temp_data[i]-'0');
                }   
                if(i>36)
                {
                    break;
                ...
                if(issig)
                {
                    data_temp.articlenum = -data_temp.articlenum  ;
                }
            }
            break;
                case 4:
            ...
            for( ; i< value_size; i++)
            {
                ...
                data_temp.languageid= data_temp.languageid * 10 + (result_temp_data[i]-'0');
                }   
                if(i>36)
                {
                    break;
                ...
                if(issig)
                {
                    data_temp.languageid = -data_temp.languageid  ;
                }
            }
            break;
