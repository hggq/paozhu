...
M_MODEL& inDepartCode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
        ...
        wheresql.append(" depart_code IN('");
				wheresql.append(B_BASE::stringaddslash(val));
				wheresql.push_back('\'');
				wheresql.push_back(')');
...
M_MODEL& inDepartCode(const std::vector<std::string> &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inDepartCode(const std::vector<T> &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninDepartCode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
        ...
        wheresql.append(" depart_code NOT IN('");
				wheresql.append(B_BASE::stringaddslash(val));
				wheresql.push_back('\'');
				wheresql.push_back(')');
...
M_MODEL& ninDepartCode(const std::vector<std::string> &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninDepartCode(const std::vector<T> &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& likeDepartCode(const std::string &val)
	{
        ...
        wheresql.append(" depart_code LIKE '%");
				wheresql.append(B_BASE::stringaddslash(val));
				wheresql.append("%'");
...
M_MODEL& l_likeDepartCode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& r_likeDepartCode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqDepartCode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqDepartCode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inDepartCode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inDepartCode(const std::vector<std::string> &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inDepartCode(const std::vector<T> &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninDepartCode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninDepartCode(const std::vector<std::string> &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninDepartCode(const std::vector<T> &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_likeDepartCode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& orl_likeDepartCode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& orr_likeDepartCode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btDepartCode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beDepartCode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltDepartCode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leDepartCode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inBianzhiNum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
        ...
        wheresql.append(" bianzhi_num IN('");
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inBianzhiNum(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inBianzhiNum(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inBianzhiNum(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninBianzhiNum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
        ...
        wheresql.append(" bianzhi_num NOT IN('");
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninBianzhiNum(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninBianzhiNum(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninBianzhiNum(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqBianzhiNum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqBianzhiNum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inBianzhiNum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inBianzhiNum(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inBianzhiNum(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inBianzhiNum(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninBianzhiNum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninBianzhiNum(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninBianzhiNum(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninBianzhiNum(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btBianzhiNum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beBianzhiNum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltBianzhiNum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leBianzhiNum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inRealNum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inRealNum(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inRealNum(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninRealNum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
        ...
        wheresql.append(" real_num NOT IN('");
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninRealNum(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninRealNum(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninRealNum(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqRealNum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqRealNum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inRealNum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inRealNum(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inRealNum(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inRealNum(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninRealNum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninRealNum(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninRealNum(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninRealNum(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btRealNum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beRealNum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltRealNum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leRealNum(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inQuanWeight(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
        ...
        wheresql.append(" quan_weight IN('");
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inQuanWeight(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inQuanWeight(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inQuanWeight(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninQuanWeight(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
        ...
        wheresql.append(" quan_weight NOT IN('");
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninQuanWeight(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninQuanWeight(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninQuanWeight(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqQuanWeight(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqQuanWeight(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inQuanWeight(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inQuanWeight(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inQuanWeight(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inQuanWeight(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninQuanWeight(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninQuanWeight(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninQuanWeight(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninQuanWeight(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btQuanWeight(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beQuanWeight(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltQuanWeight(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leQuanWeight(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inIsvirtual(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inIsvirtual(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inIsvirtual(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inIsvirtual(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninIsvirtual(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
        ...
        wheresql.append(" isvirtual NOT IN('");
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninIsvirtual(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninIsvirtual(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninIsvirtual(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqIsvirtual(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqIsvirtual(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inIsvirtual(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inIsvirtual(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inIsvirtual(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inIsvirtual(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninIsvirtual(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninIsvirtual(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninIsvirtual(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninIsvirtual(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btIsvirtual(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beIsvirtual(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltIsvirtual(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leIsvirtual(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inLinkdpid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inLinkdpid(const std::vector<std::string> &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inLinkdpid(const std::vector<T> &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninLinkdpid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
        ...
        wheresql.append(" linkdpid NOT IN('");
				wheresql.append(B_BASE::stringaddslash(val));
				wheresql.push_back('\'');
				wheresql.push_back(')');
...
M_MODEL& ninLinkdpid(const std::vector<std::string> &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninLinkdpid(const std::vector<T> &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& l_likeLinkdpid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& r_likeLinkdpid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqLinkdpid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqLinkdpid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inLinkdpid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inLinkdpid(const std::vector<std::string> &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inLinkdpid(const std::vector<T> &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninLinkdpid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninLinkdpid(const std::vector<std::string> &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninLinkdpid(const std::vector<T> &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_likeLinkdpid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& orl_likeLinkdpid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& orr_likeLinkdpid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btLinkdpid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beLinkdpid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltLinkdpid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leLinkdpid(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leLinkdpid(T val)
	{
        ...
        template <typename T2>
        M_MODEL &where(department_info::cols field, orm::wq opwq, T2 &&value)
        {
            if (wheresql.empty())
            {
            }
        ...
        template <typename T2>
        M_MODEL &whereOr(department_info::cols field, orm::wq opwq, T2 &&value)
        {
            if (wheresql.empty())
            {
            }
