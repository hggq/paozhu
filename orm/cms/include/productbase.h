    ...
    std::string getstrCol(std::string keyname, [[maybe_unused]] bool isyinhao = false)
    {
        ...
        for (auto &iter : record)
        {
            ...
            case 16:
                if (isyinhao)
                {
                    a << jsonaddslash(iter.maincontent);
                }
                else
                {
                    a << iter.maincontent;
            ...
            case 17:
                if (isyinhao)
                {
                    a << jsonaddslash(iter.paracontent);
                }
                else
                {
                    a << iter.paracontent;
            ...
            case 19:
                if (isyinhao)
                {
                    a << jsonaddslash(iter.attatchfiles);
                }
                else
                {
                    a << iter.attatchfiles;
