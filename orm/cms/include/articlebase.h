    ...
    std::string getstrCol(std::string keyname, [[maybe_unused]] bool isyinhao = false)
    {
        ...
        for (auto &iter : record)
        {
            ...
            case 8:
                if (isyinhao)
                {
                    a << jsonaddslash(iter.fromsource);
                }
                else
                {
                    a << iter.fromsource;
            ...
            case 11:
                if (isyinhao)
                {
                    a << jsonaddslash(iter.createtime);
                }
                else
                {
                    a << iter.createtime;
            ...
            case 25:
                if (isyinhao)
                {
                    a << jsonaddslash(iter.editauthor);
                }
                else
                {
                    a << iter.editauthor;
            ...
            case 26:
                if (isyinhao)
                {
                    a << jsonaddslash(iter.relatecontent);
                }
                else
                {
