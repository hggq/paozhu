...
M_MODEL& inRolecode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inRolecode(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inRolecode(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inRolecode(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninRolecode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
        ...
        wheresql.append(" rolecode NOT IN('");
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninRolecode(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninRolecode(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninRolecode(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqRolecode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqRolecode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inRolecode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inRolecode(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inRolecode(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inRolecode(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninRolecode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninRolecode(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninRolecode(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninRolecode(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btRolecode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beRolecode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltRolecode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leRolecode(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inRolevalue(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inRolevalue(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& inRolevalue(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& inRolevalue(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninRolevalue(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
        ...
        wheresql.append(" rolevalue NOT IN('");
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninRolevalue(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& ninRolevalue(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& ninRolevalue(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_eqRolevalue(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_nqRolevalue(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inRolevalue(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inRolevalue(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_inRolevalue(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_inRolevalue(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninRolevalue(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninRolevalue(const T &val)
	{
        if (wheresql.empty())
        {
        }
...
template <typename T>
	requires std::is_integral_v<T>
M_MODEL& or_ninRolevalue(const std::vector<T>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ninRolevalue(const std::vector<std::string>& val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_btRolevalue(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_beRolevalue(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_ltRolevalue(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leRolevalue(const std::string &val)
	{
        if (wheresql.empty())
        {
        }
...
M_MODEL& or_leRolevalue(T val)
	{
        ...
        template <typename T2>
        M_MODEL &where(sysrole_info::cols field, orm::wq opwq, T2 &&value)
        {
            if (wheresql.empty())
            {
            }
        ...
        template <typename T2>
        M_MODEL &whereOr(sysrole_info::cols field, orm::wq opwq, T2 &&value)
        {
            if (wheresql.empty())
            {
            }
