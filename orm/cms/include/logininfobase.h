...
static constexpr std::array<std::string,10> col_names={"lgid","userid","logtype","username","addtime","addip","addregion","loginstate","agent","urlpath"};
...
static constexpr std::string modelname="Logininfo";
