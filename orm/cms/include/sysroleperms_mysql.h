...
{ /*tagnamespace_replace*/
    ...
    class sysroleperms_mysql : public B_BASE
    {
      public:
        ...
        void assign_field_value(unsigned char index_pos, unsigned char *result_temp_data, unsigned int value_size, sysroleperms_info::meta &data_temp)
    {
        switch(index_pos)
        {
            case 0:
            ...
            for(unsigned int i=0; i< value_size; i++)
            {
                ...
                data_temp.rolepermsid= data_temp.rolepermsid * 10 + (result_temp_data[i]-'0');
                }   
                if(i>32)
                {
                    break;
            ...
            for(unsigned int i=0; i< value_size; i++)
            {
                ...
                data_temp.permsid= data_temp.permsid * 10 + (result_temp_data[i]-'0');
                }   
                if(i>32)
                {
                    break;
