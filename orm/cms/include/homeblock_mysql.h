...
{ /*tagnamespace_replace*/
    ...
    class homeblock_mysql : public B_BASE
    {
      public:
        homeblock_mysql(const std::string &tag) : dbtag(tag)
        {
        ...
        homeblock_mysql() : dbtag(B_BASE::_rmstag)
        {
            std::map<std::string, std::shared_ptr<orm_conn_pool>> &conn_pool_obj = get_orm_conn_pool_obj();
            auto iter                                                            = conn_pool_obj.find(dbtag);
            if (iter != conn_pool_obj.end())
        ...
        void assign_field_value(unsigned char index_pos, unsigned char *result_temp_data, unsigned int value_size, homeblock_info::meta &data_temp)
    {
        switch(index_pos)
        {
            case 0:
            ...
            for( ; i< value_size; i++)
            {
                ...
                data_temp.hbid= data_temp.hbid * 10 + (result_temp_data[i]-'0');
                }   
                if(i>36)
                {
                    break;
            ...
            for( ; i< value_size; i++)
            {
                ...
                data_temp.viewtype= data_temp.viewtype * 10 + (result_temp_data[i]-'0');
                }   
                if(i>36)
                {
                    break;
                ...
                if(issig)
                {
                    data_temp.viewtype = -data_temp.viewtype  ;
                }
            }
            break;
                case 6:
            ...
            for( ; i< value_size; i++)
            {
                ...
                data_temp.gettype= data_temp.gettype * 10 + (result_temp_data[i]-'0');
                }   
                if(i>36)
                {
                    break;
                ...
                if(issig)
                {
                    data_temp.gettype = -data_temp.gettype  ;
                }
            }
            break;
                case 7:
            ...
            for( ; i< value_size; i++)
            {
                ...
                data_temp.rownum= data_temp.rownum * 10 + (result_temp_data[i]-'0');
                }   
                if(i>36)
                {
                    break;
                ...
                if(issig)
                {
                    data_temp.rownum = -data_temp.rownum  ;
                }
            }
            break;
                case 8:
            ...
            for( ; i< value_size; i++)
            {
                ...
                data_temp.width= data_temp.width * 10 + (result_temp_data[i]-'0');
                }   
                if(i>36)
                {
                    break;
                ...
                if(issig)
                {
                    data_temp.width = -data_temp.width  ;
                }
            }
            break;
                case 9:
            ...
            for( ; i< value_size; i++)
            {
                ...
                data_temp.height= data_temp.height * 10 + (result_temp_data[i]-'0');
                }   
                if(i>36)
                {
                    break;
                ...
                if(issig)
                {
                    data_temp.height = -data_temp.height  ;
                }
            }
            break;
                case 10:
            ...
            for( ; i< value_size; i++)
            {
                ...
                data_temp.strlength= data_temp.strlength * 10 + (result_temp_data[i]-'0');
                }   
                if(i>36)
                {
                    break;
                ...
                if(issig)
                {
                    data_temp.strlength = -data_temp.strlength  ;
                }
            }
            break;
                case 11:
