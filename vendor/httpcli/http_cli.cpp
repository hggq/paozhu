...
int main(int argc, char *argv[]){
    ...
    if(argc==1){
        std::cout<<argv[0]<<" \033[1m\033[31m model ｜ view | viewtocpp | control \033[0m  \n 🎉 Welcome to use \033[4m\033[31mcli\033[0m to manage your MVC files。\n";
   ...
   // std::string commandstr{argv[1]};
    while(1){
        ...
        commandstr.clear();
         std::cout<<"(m)model (v)view (f)viewtocpp or (c)control,x or q to exit[input\033[1m\033[32m m|v|f|c|\033[0m]:";
         std::cin>>commandstr;
         ...
         if(commandstr.size()==1&&(commandstr[0]=='f'||commandstr[0]=='F')){
