...
namespace http
{
     void http2parse::setsession(std::shared_ptr<client_session> peer)
     {
     ...
     void http2parse::cookie_process(const std::string &header_name, const std::string &header_value)
     {
          ...
          for (; i < linesize; i++)
          {
               ...
               {
                    data_info[block_steamid].buffer_key = http::url_decode(data_info[block_steamid].buffer_value.data(), data_info[block_steamid].buffer_value.length());
                    data_info[block_steamid].buffer_value.clear();
                    continue;
               }
               if (header_value[i] == 0x3B)
               {
                    data_info[block_steamid].buffer_value = http::url_decode(data_info[block_steamid].buffer_value.data(), data_info[block_steamid].buffer_value.length());
     ...
     void http2parse::path_process(const std::string &header_name, const std::string &header_value)
     {
          ...
          for (; ioffset < linesize; ioffset++)
          {
               ...
               if (header_value[ioffset] == 0x2F)
               {
                    if (data_info[block_steamid].buffer_key.size() > 0)
                    {
                         if (data_info[block_steamid].buffer_key.size() == 2 && data_info[block_steamid].buffer_key[0] == '.' && data_info[block_steamid].buffer_key[1] == '.')
                         {
                         ...
                         {
                              http_data[block_steamid]->pathinfos.emplace_back(http::url_decode(data_info[block_steamid].buffer_key.data(), data_info[block_steamid].buffer_key.length()));
                         }
                         data_info[block_steamid].buffer_key.clear();
                    }
               }
          ...
          if (headerstep == 6)
          {
               ...
               http_data[block_steamid]->urlpath = http::url_decode(data_info[block_steamid].buffer_value.data(), data_info[block_steamid].buffer_value.length());
          }
          else
          {
               http_data[block_steamid]->header["urlpath"] = data_info[block_steamid].buffer_value;
          ...
          if (headerstep == 6)
          {
               ...
               http_data[block_steamid]->querystring = http::url_decode(data_info[block_steamid].buffer_key.data(), data_info[block_steamid].buffer_key.length());
                         ...
                         if (ishaskey2)
                         {
                              ...
                              else
                              {
                                   ...
                                   else
                                   {
                                        ...
                                        http_data[block_steamid]->get[objname][key1name][key2name] = data_info[block_steamid].buffer_value;
                                   }
                              }
                              j = m;
                              isgroup = false;
     ...
     void http2parse::getaccept(const std::string &header_name, const std::string &header_value)
     {
          ...
          for (; i < linesize; i++)
          {
               if (header_value[i] == 0x2C || header_value[i] == 0x3B)
               {
                    ...
                    {
                    case 10:
                         if (data_info[block_steamid].buffer_value[6] == 'a' && data_info[block_steamid].buffer_value[7] == 'v' && data_info[block_steamid].buffer_value[8] == 'i' && data_info[block_steamid].buffer_value[9] == 'f')
                         {
                              http_data[block_steamid]->state.avif = true;
                         }
                         else if (data_info[block_steamid].buffer_value[6] == 'w' && data_info[block_steamid].buffer_value[7] == 'e' && data_info[block_steamid].buffer_value[8] == 'b' && data_info[block_steamid].buffer_value[9] == 'p')
                         {
     ...
     void http2parse::readping(const unsigned char *buffer, unsigned int buffersize)
     {
          unsigned int j = readoffset;
          processheader = 0;
          unsigned char _recvack[] = {0x00, 0x00, 0x08, 0x06, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
          int i = 0;
          for (; j < buffersize; j++)
          {
               if (i < 8)
          ...
          processheader = 0;
          readoffset += blocklength;
          peer_session->write_data(_recvack, 17);
     }
                         ...
                         if (ishaskey2)
                         {
                              ...
                              else
                              {
                                   ...
                                   else
                                   {
                                        ...
                                        http_data[block_steamid]->post[objname][key1name][key2name] = data_info[block_steamid].field_value;
                                   }
                              }
                              j = m;
                              isgroup = false;
     ...
     void http2parse::procssformfile()
     {
                    ...
                    if (ishaskey)
                    {
                         ...
                         if (ishaskey2)
                         {
                              ...
                              else
                              {
                                   ...
                                   else
                                   {
                                        ...
                                        http_data[block_steamid]->files[objname][key1name][key2name]["filename"] = data_info[block_steamid].upfile.filename;
                                        http_data[block_steamid]->files[objname][key1name][key2name]["name"] = data_info[block_steamid].upfile.name;
                                        http_data[block_steamid]->files[objname][key1name][key2name]["tempfile"] = data_info[block_steamid].upfile.tempfile;
                                        http_data[block_steamid]->files[objname][key1name][key2name]["type"] = data_info[block_steamid].upfile.type;
                                        http_data[block_steamid]->files[objname][key1name][key2name]["size"] = data_info[block_steamid].upfile.size;
                                        http_data[block_steamid]->files[objname][key1name][key2name]["error"] = data_info[block_steamid].upfile.error;
                                   }
                              }
                              j = m;
                              isgroup = false;
                         ...
                         else if (n == data_info[block_steamid].upfile.name.length())
                         {
                              ...
                              else
                              {
                                   ...
                                   http_data[block_steamid]->files[objname][key1name].set_array();
                                   http_data[block_steamid]->files[objname][key1name]["filename"] = data_info[block_steamid].upfile.filename;
                                   http_data[block_steamid]->files[objname][key1name]["name"] = data_info[block_steamid].upfile.name;
                                   http_data[block_steamid]->files[objname][key1name]["tempfile"] = data_info[block_steamid].upfile.tempfile;
                                   http_data[block_steamid]->files[objname][key1name]["type"] = data_info[block_steamid].upfile.type;
                                   http_data[block_steamid]->files[objname][key1name]["size"] = data_info[block_steamid].upfile.size;
                                   http_data[block_steamid]->files[objname][key1name]["error"] = data_info[block_steamid].upfile.error;
                              }
                              j = n;
                              isgroup = false;
                         }
          ...
          if (isgroup)
          {
               ...
               http_data[block_steamid]->files[data_info[block_steamid].upfile.name]["filename"] = data_info[block_steamid].upfile.filename;
               http_data[block_steamid]->files[data_info[block_steamid].upfile.name]["name"] = data_info[block_steamid].upfile.name;
               http_data[block_steamid]->files[data_info[block_steamid].upfile.name]["tempfile"] = data_info[block_steamid].upfile.tempfile;
               http_data[block_steamid]->files[data_info[block_steamid].upfile.name]["type"] = data_info[block_steamid].upfile.type;
               http_data[block_steamid]->files[data_info[block_steamid].upfile.name]["size"] = data_info[block_steamid].upfile.size;
               http_data[block_steamid]->files[data_info[block_steamid].upfile.name]["error"] = data_info[block_steamid].upfile.error;
          }
     ...
     void http2parse::readmultipartformdata(const unsigned char *buffer, unsigned int buffersize)
     {
          ...
          for (unsigned int i = 0; i < buffersize;)
          {
               ...
               case 0:
                    ...
                    break;
               case 2:
                    readformfilename(buffer, i, buffersize);
                    break;
               case 4:
                    readformfieldcontent(buffer, i, buffersize);
                    break;
               case 6:
                    readformfieldfilecontent(buffer, i, buffersize);
                    break;
               default:
                    i++;
               }
