...
std::string displaydirectory(std::string localpath, std::string urlpath,
                             std::string dir_sort, std::string configpath)
{
  ...
  {
    std::sort(fileslists.begin(), fileslists.end(),
              [](directorylist_t const &a, directorylist_t const &b)
