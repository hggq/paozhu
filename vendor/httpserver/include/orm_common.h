...
struct orm_conn_t
{
    ...
    {
        return std::tie(host, port, dbname, user, password, pretable, dbtype, tag, charset, sslhost, isssl, sslverify, issock, isdebug, islocal, link_type, max_pool, min_pool, charset_val, db_type) ==
               std::tie(o.host, o.port, o.dbname, o.user, o.password, o.pretable, o.dbtype, o.tag, o.charset, o.sslhost, o.isssl, o.sslverify, o.issock, o.isdebug, o.islocal, o.link_type, o.max_pool, o.min_pool, o.charset_val, o.db_type);
    }
