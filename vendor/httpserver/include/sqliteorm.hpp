#ifndef HTTP_SQLITE_ORM_HPP
#define HTTP_SQLITE_ORM_HPP
/*
...
{ /*tagnamespace_replace*/
    ...
    class mysql_orm : public B_BASE
    {
      public:
        ...
        mysql_orm() : dbtag(B_BASE::_rmstag)
        {
            std::map<std::string, std::shared_ptr<orm_conn_pool>> &conn_pool_obj = get_orm_conn_pool_obj();
            auto iter                                                            = conn_pool_obj.find(dbtag);
            if (iter != conn_pool_obj.end())
        ...
        M_MODEL &whereIn(typename B_BASE::cols field, const std::vector<T2> &a)
        {
            return whereIn(field, orm::wq::in, a);
        }

        template <typename T2>
        M_MODEL &whereNotIn(typename B_BASE::cols field, const std::vector<T2> &a)
        {
            return whereIn(field, orm::wq::notin, a);
        }

        template <typename T2>
        M_MODEL &whereOrIn(typename B_BASE::cols field, const std::vector<T2> &a)
        {
            return whereOrIn(field, orm::wq::in, a);
        }

        template <typename T2>
        M_MODEL &whereOrNotIn(typename B_BASE::cols field, const std::vector<T2> &a)
        {
        ...
        M_MODEL &whereNull(typename B_BASE::cols field)
        {
            orm_where_sql_t item;
            item.pre_op     = wheresql.empty() ? 0 : 1;
        ...
        M_MODEL &whereOrNull(typename B_BASE::cols field)
        {
            orm_where_sql_t item;
            item.pre_op     = wheresql.empty() ? 0 : 2;
            item.op_type    = orm::wq::isnull;
        ...
        M_MODEL &whereNotNull(typename B_BASE::cols field)
        {
            orm_where_sql_t item;
            item.pre_op     = wheresql.empty() ? 0 : 1;
        ...
        M_MODEL &whereOrNotNull(typename B_BASE::cols field)
        {
            orm_where_sql_t item;
            item.pre_op     = wheresql.empty() ? 0 : 2;
            item.op_type    = orm::wq::notnull;
        ...
        template <typename T2>
        M_MODEL &whereEQ(typename B_BASE::cols field, T2 &&value)
        {
        ...
        template <typename T2>
        M_MODEL &whereAnd(typename B_BASE::cols field, T2 &&value)
        {
            return where(field, orm::wq::eq, std::forward<T2>(value));
        }
        ...
        template <typename T2>
        M_MODEL &whereBT(typename B_BASE::cols field, T2 &&value)
        {
        ...
        template <typename T2>
        M_MODEL &whereGT(typename B_BASE::cols field, T2 &&value)
        {
            return where(field, orm::wq::bt, std::forward<T2>(value));
        }
        ...
        template <typename T2>
        M_MODEL &whereBE(typename B_BASE::cols field, T2 &&value)
        {
        ...
        template <typename T2>
        M_MODEL &whereGE(typename B_BASE::cols field, T2 &&value)
        {
            return where(field, orm::wq::be, std::forward<T2>(value));
        }
        ...
        template <typename T2>
        M_MODEL &whereLT(typename B_BASE::cols field, T2 &&value)
        {
        ...
        template <typename T2>
        M_MODEL &whereLE(typename B_BASE::cols field, T2 &&value)
        {
        ...
        template <typename T2>
        M_MODEL &whereNQ(typename B_BASE::cols field, T2 &&value)
        {
        ...
        template <typename T2>
        M_MODEL &whereNE(typename B_BASE::cols field, T2 &&value)
        {
            return where(field, orm::wq::nq, std::forward<T2>(value));
        }
        ...
        template <typename T2>
        M_MODEL &whereLike(typename B_BASE::cols field, T2 &&value)
        {
        ...
        template <typename T2>
        M_MODEL &whereLikeLeft(typename B_BASE::cols field, T2 &&value)
        {
        ...
        template <typename T2>
        M_MODEL &whereLikeRight(typename B_BASE::cols field, T2 &&value)
        {
        ...
        template <typename T2>
        M_MODEL &whereNotLike(typename B_BASE::cols field, T2 &&value)
        {
        ...
        template <typename T2>
        M_MODEL &whereOrBT(typename B_BASE::cols field, T2 &&value)
        {
        ...
        template <typename T2>
        M_MODEL &whereOrBE(typename B_BASE::cols field, T2 &&value)
        {
        ...
        template <typename T2>
        M_MODEL &whereOrLT(typename B_BASE::cols field, T2 &&value)
        {
        ...
        template <typename T2>
        M_MODEL &whereOrLE(typename B_BASE::cols field, T2 &&value)
        {
        ...
        template <typename T2>
        M_MODEL &whereOrNQ(typename B_BASE::cols field, T2 &&value)
        {
        ...
        template <typename T2>
        M_MODEL &whereOrLike(typename B_BASE::cols field, T2 &&value)
        {
        ...
        template <typename T2>
        M_MODEL &whereOrLikeLeft(typename B_BASE::cols field, T2 &&value)
        {
        ...
        template <typename T2>
        M_MODEL &whereOrLikeRight(typename B_BASE::cols field, T2 &&value)
        {
        ...
        template <typename T2>
        M_MODEL &whereOrNotLike(typename B_BASE::cols field, T2 &&value)
        {
        ...
        M_MODEL &order(typename B_BASE::cols field, const std::string &asc_or_desc)
        {
        ...
        M_MODEL &asc(typename B_BASE::cols field)
        {
            ordersql.append(" ORDER BY ");
            switch (field)
            {
        ...
        M_MODEL &desc(typename B_BASE::cols field)
        {
        ...
        M_MODEL &having(typename B_BASE::cols field)
        {
            groupsql.append(" HAVING ");
            switch (field)
            {
        ...
        M_MODEL &group(typename B_BASE::cols field)
        {
        ...
        M_MODEL &joinOn(std::string_view join_field, B_BASE::cols main_field)
        {
            ...
            item.left_filed_name  = B_BASE::col_names[item.left_idx];
        ...
        mysql_orm(const mysql_orm &)            = delete;
        mysql_orm &operator=(const mysql_orm &) = delete;
        mysql_orm(mysql_orm &&o) noexcept : B_BASE(std::move(o))
        {
        ...
        mysql_orm &operator=(mysql_orm &&o) noexcept
        {
            if (this != &o)
            {
      ...
      public:
        ...
        unsigned int exec_update()
        {
            ...
            std::vector<http::obj_val> params;
            bool first = true;
            for (unsigned char i = 0; i < B_BASE::col_names.size(); i++)
            {
                // 跳过自增主键：全字段更新不修改身份列（“自增主键跳过”约定），避免把主键误改为 0
                if (static_cast<int>(i) == B_BASE::auto_pk_index)
                    continue;
                if (!first)
                    sql.append(", ");
                sql.append(B_BASE::col_names[i]);
                sql.append(" = ?");
        ...
        unsigned int exec_update_dirty()
        {
            ...
            for (auto idx : dirty_indices)
            {
                if (!first)
                    sql.append(", ");
                sql.append(B_BASE::col_names[idx]);
                sql.append(" = ?");
        ...
        std::tuple<unsigned int, unsigned long long> exec_insert_batch()
        {
            ...
            const unsigned char ncols = B_BASE::col_names.size();
