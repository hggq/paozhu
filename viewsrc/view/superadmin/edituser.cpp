...
#include "viewsrc.h"
//g++ viewsrc/view/superadmin/edituser.cpp
namespace http {

namespace view {
	namespace superadmin{
 		 std::string edituser([[maybe_unused]] const struct view_param &vinfo,[[maybe_unused]] http::OBJ_VALUE &obj)
			{
...
echo<<obj["info"]["userid"].to_string(); 
