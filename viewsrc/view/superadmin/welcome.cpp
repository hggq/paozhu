...
namespace view {
	namespace superadmin{
 		 std::string welcome([[maybe_unused]] const struct view_param &vinfo,[[maybe_unused]] http::OBJ_VALUE &obj)
			{
 ...
 for(auto &a:obj["infos"].as_array()){ 
 			 echo<<"            <tr>\n              <td>";
 echo<<a.second["sid"].to_string(); 
 			 echo<<"</td>\n              <td>";
 echo<<a.second["companyname"].to_string(); 
 			 echo<<"</td>\n              <td>";
 echo<<a.second["sitename"].to_string(); 
 			 echo<<"</td>\n              <td>";
 echo<<a.second["sitedomain"].to_string(); 
 			 echo<<"</td>\n              <td>";
