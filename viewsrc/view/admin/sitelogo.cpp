...
#include "viewsrc.h"
//This file create by paozhu Sat, 09 Aug 2025 05:08:05 GMT
namespace http {

namespace view {
	namespace admin{
 		 std::string sitelogo([[maybe_unused]] const struct view_param &vinfo,[[maybe_unused]] http::obj_val &obj)
			{
...
echo<<obj["info"]["sid"].to_string(); 
 			 echo<<"\" />\n            </div>\n          </div>\n\n        </form>\n      </div>\n    </div>\n\n  </div>\n\n    <div class=\"container-fluid card\" style=\"margin-top: 50px;\">\n    <h5 class=\"card-title mt-2\">网站Banner</h5>\n    <hr>\n    <div class=\"row\">\n      <div class=\"col-12\">\n        <form id=\"form\" action=\"/admin/sitebannerpost\" method=\"post\">\n          <div class=\"row mb-3\">\n            <div class=\"ml-2\">（格式为png、svg或jpg）</div>\n          </div>\n          <div class=\"row mb-3\">\n            <div class=\"col-sm-10 offset-sm-2 ml-2\"><div id=\"progress-bar-result\">\n              ";
std::string tempbannerurl=obj["info"]["sitebanner"].to_string();  if(tempbannerurl.size()>0){ 
 			 echo<<"              <a href=\"";
echo << obj["info"]["sitebanner"].to_string(); 
 			 echo<<"?";
echo << timeid(); 
 			 echo<<"\" target=\"_blank\"><img src=\"";
echo << obj["info"]["sitebanner"].to_string(); 
