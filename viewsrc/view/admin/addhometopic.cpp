...
#include "viewsrc.h"
//g++ viewsrc/view/admin/addhometopic.cpp
namespace http {

namespace view {
	namespace admin{
 		 std::string addhometopic([[maybe_unused]] const struct view_param &vinfo,[[maybe_unused]] http::obj_val &obj)
			{
...
echo<<obj["info"]["topicid_content"].to_string(); 
 			 echo<<"\">\n        </div>\n      </div>  \n      <div class=\"row\">\n        ";
 for(auto &a:obj["list"].ref_array()){ 
