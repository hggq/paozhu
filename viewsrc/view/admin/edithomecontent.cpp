...
#include "viewsrc.h"
//g++ viewsrc/view/admin/edithomecontent.cpp
namespace http {

namespace view {
	namespace admin{
 		 std::string edithomecontent([[maybe_unused]] const struct view_param &vinfo,[[maybe_unused]] http::OBJ_VALUE &obj)
			{
...
echo<<a.second["topicid"].to_string(); 
 			 echo<<"\" ";
echo<<a.second["checked"].to_string(); 
 			 echo<<"\">\n              </div>\n              \n          </div>\n           ";
 } 
