...
namespace view {
	namespace admin{
 		 std::string addtopicsidetext([[maybe_unused]] const struct view_param &vinfo,[[maybe_unused]] http::obj_val &obj)
			{
