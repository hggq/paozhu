...
**Paozhu**(炮竹🧨)是一个全面、快速的C++ web framework 开发框架，我们口号是“为 C++ Web 快速开发而生”，集成C++ ORM，开发速度跟脚本语言一样，日写1000行业务代码没有压力，框架集成了WebServer，自己原生解析HTTP/1、HTTP/2、JSON协议，GET、POST全部解析出来，POST几种方式都做了区分，框架自带一个OBJ微型对象，可以存放char
