...
add_includedirs("sockets")
add_includedirs("websockets")
...
target("paozhu_cli")
    ...
    add_files("vendor/httpserver/src/orm_conn_pool.cpp")
    add_files("vendor/httpserver/src/orm_common.cpp")
    add_files("vendor/httpserver/src/pg_conn.cpp")
