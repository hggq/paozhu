...
if is_plat("windows") then
    package("mysql")    
        ...
        set_urls("https://dev.mysql.com/get/Downloads/MySQL-8.0/mysql-8.0.35.zip")
        add_versions("8.0.35", "3788aeb0b02b6491d1ca0b3f082a3f86b614a215ce9657d379050d2946e4b6f3")
